...
import { DocumentComponent } from './components/profile/document/document.component';
...
@NgModule({
  ...
  providers: [{ provide: NZ_I18N, useValue: pl_PL }, { provide: MAT_DATE_FORMATS, useValue: MY_DATE_FORMATS }, HeaderComponent],
